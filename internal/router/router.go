...
func SetupRouter(cfg *config.Config, db *gorm.DB, hub *ws.Hub) *gin.Engine {
	...
	api.Use(middleware.AuthMiddleware(cfg.JWTSecret, userRepo))
	{
		...
		tenant.Use(middleware.TenantMiddleware(accountRepo))
		{
			...
			tenant.POST("/inboxes/:id/assignment_policy", inboxHandler.BindAssignmentPolicy)

			// 独立分配策略 (Assignment Policies)
			tenant.GET("/assignment_policies", assignmentPolicyHandler.List)
			tenant.POST("/assignment_policies", assignmentPolicyHandler.Create)
			tenant.GET("/assignment_policies/:id", assignmentPolicyHandler.Get)
			tenant.PUT("/assignment_policies/:id", assignmentPolicyHandler.Update)
			tenant.DELETE("/assignment_policies/:id", assignmentPolicyHandler.Delete)

			// 客服容量策略 (Agent Capacity Policies - Chatwoot Enterprise)
			tenant.GET("/agent_capacity_policies", agentCapacityPolicyHandler.List)
			tenant.POST("/agent_capacity_policies", agentCapacityPolicyHandler.Create)
			tenant.GET("/agent_capacity_policies/:id", agentCapacityPolicyHandler.Show)
			tenant.PUT("/agent_capacity_policies/:id", agentCapacityPolicyHandler.Update)
			tenant.DELETE("/agent_capacity_policies/:id", agentCapacityPolicyHandler.Delete)
			tenant.GET("/agent_capacity_policies/:id/users", agentCapacityPolicyHandler.ListUsers)
			tenant.POST("/agent_capacity_policies/:id/users", agentCapacityPolicyHandler.AddUser)
			tenant.DELETE("/agent_capacity_policies/:id/users/:user_id", agentCapacityPolicyHandler.RemoveUser)
			tenant.POST("/agent_capacity_policies/:id/inbox_limits", agentCapacityPolicyHandler.CreateInboxLimit)
			tenant.PUT("/agent_capacity_policies/:id/inbox_limits/:limit_id", agentCapacityPolicyHandler.UpdateInboxLimit)
			tenant.DELETE("/agent_capacity_policies/:id/inbox_limits/:limit_id", agentCapacityPolicyHandler.DeleteInboxLimit)
			...
			tenant.PUT("/campaigns/:id", advancedHandler.UpdateCampaign)
			tenant.PATCH("/campaigns/:id", advancedHandler.UpdateCampaign)
			tenant.DELETE("/campaigns/:id", advancedHandler.DeleteCampaign)
			tenant.POST("/campaigns/:id/trigger", advancedHandler.TriggerCampaign)
			tenant.POST("/campaigns/:id/pause", advancedHandler.PauseCampaign)
			tenant.POST("/campaigns/:id/resume", advancedHandler.ResumeCampaign)
			tenant.POST("/campaigns/:id/stop", advancedHandler.StopCampaign)
			tenant.POST("/campaigns/:id/cancel", advancedHandler.CancelCampaign)
			...
			tenant.PUT("/captain/assistants/:id", copilotHandler.UpdateAssistant)
			tenant.PATCH("/captain/assistants/:id", copilotHandler.UpdateAssistant)
			tenant.DELETE("/captain/assistants/:id", copilotHandler.DeleteAssistant)

			// Captain 助手收件箱绑定 (Inboxes)
			tenant.GET("/captain/assistants/:id/inboxes", copilotHandler.ListAssistantInboxes)
			tenant.POST("/captain/assistants/:id/inboxes", copilotHandler.BindAssistantInbox)
			tenant.DELETE("/captain/assistants/:id/inboxes/:inbox_id", copilotHandler.UnbindAssistantInbox)
			...
			tenant.POST("/captain/assistant_responses", copilotHandler.CreateAssistantResponse)
			tenant.GET("/captain/assistant_responses/:id", copilotHandler.GetAssistantResponse)
			tenant.PUT("/captain/assistant_responses/:id", copilotHandler.UpdateAssistantResponse)
			tenant.PATCH("/captain/assistant_responses/:id", copilotHandler.UpdateAssistantResponse)
			tenant.DELETE("/captain/assistant_responses/:id", copilotHandler.DeleteAssistantResponse)
			// FAQ 别名支持
			tenant.GET("/captain/faqs", copilotHandler.ListAssistantResponses)
			tenant.POST("/captain/faqs", copilotHandler.CreateAssistantResponse)
			tenant.GET("/captain/faqs/:id", copilotHandler.GetAssistantResponse)
			tenant.PUT("/captain/faqs/:id", copilotHandler.UpdateAssistantResponse)
			tenant.PATCH("/captain/faqs/:id", copilotHandler.UpdateAssistantResponse)
			tenant.DELETE("/captain/faqs/:id", copilotHandler.DeleteAssistantResponse)
			tenant.GET("/captain/assistants/:id/faqs", copilotHandler.ListAssistantResponses)
			tenant.POST("/captain/assistants/:id/faqs", copilotHandler.CreateAssistantResponse)
			...
			tenant.POST("/data_imports/prevalidate", authEnterpriseHandler.PrevalidateDataImport)
			tenant.GET("/data_imports/:id", authEnterpriseHandler.GetDataImport)
			tenant.POST("/data_imports/:id/prevalidate", authEnterpriseHandler.PrevalidateDataImport)
			tenant.POST("/data_imports/:id/start", authEnterpriseHandler.StartDataImport)
			tenant.POST("/data_imports/:id/execute", authEnterpriseHandler.StartDataImport)
			tenant.POST("/data_imports/:id/cancel", authEnterpriseHandler.CancelDataImport)
			tenant.POST("/data_imports/:id/discard", authEnterpriseHandler.DiscardDataImport)
			tenant.GET("/data_imports/:id/errors", authEnterpriseHandler.GetImportErrors)
			tenant.GET("/data_imports/:id/errors/download", authEnterpriseHandler.DownloadImportErrors)
			tenant.GET("/data_imports/:id/error_report", authEnterpriseHandler.DownloadImportErrors)
			tenant.GET("/data_imports/:id/skipped", authEnterpriseHandler.GetImportSkipped)
			tenant.GET("/data_imports/:id/skipped/download", authEnterpriseHandler.DownloadSkippedRecords)
			tenant.GET("/data_imports/:id/skipped_records", authEnterpriseHandler.DownloadSkippedRecords)
